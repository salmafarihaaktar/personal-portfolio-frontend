...
export default function DataDrivenTimeline() {
            ...
            {experience.map((exp, index) => (
              ...
              >
                <div className="relative group">
                  ...
                  <div
                    className={cn(
                      "absolute left-0 md:left-1/2 top-0 w-4 h-4 rounded-full border-4 -translate-x-1/2 bg-background transition-all duration-500 group-hover:scale-125",
                      "border-muted-foreground/50 group-hover:border-primary group-hover:shadow-lg group-hover:shadow-primary/30"
                    )}
                  />
